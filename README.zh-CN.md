...
[下载安装包](https://github.com/cubebear/shengjian-voice-studio/releases/tag/v0.1.0) · [手把手教程](使用说明.md) · [中文发行说明](docs/RELEASE_NOTES.zh-CN.md)
...
[负责任使用说明](RESPONSIBLE_USE.md) 是用途与法律风险提示，不给 MIT 许可证增加用途限制；开源许可证也不授予任何人的声音、肖像或身份使用权。请勿导入来源不明的模型与声音文件；第三方原生解析器尚未经过完整安全审计。更多说明见 [SECURITY.md](SECURITY.md)。
